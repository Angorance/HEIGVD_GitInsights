const tipMessageCommitLength95 = 'You are supposed to write a short description of the work that was done, not the complete report for the client nor an official mail to the intention of the head of the company. You have to be concise yet clear. We know it is a hard skill to master, but it is necessary to know when to stop in order to be the G.O.A.T. in commit messages redaction.';

const tipMessageCommitLength70 = 'We see that you put some extra effort in your commit message redaction, that\'s cool and all, but maybe you\'re taking this "detailing" thing a bit too far. You and your colleagues will have to read those, so maybe try to ease off on the keyboard, and go get yourself a chocolate milk. You deserved it ;)';

const tipMessageCommitLength50 = 'Congratulation, fellow programmer. You now belong to the elite in term of writing commit messages. The bug fix description has no more secrets to you. You can now wander in the vales of the Internet in order to spread the holy teaching. Keep your mind clear and your keys sharp. May the semi-colon be with you. Amen';

const tipMessageCommitLength25 = 'Hey not bad, you\'re doing pretty god! But if you want to be the very best, like no one ever was, you still have to improve this legendary skill known as "write good commit messages". Maybe you were a bit vague in your message, or you missed a functionality/feature/fix/bug to comment. Keep on typing, you are close to excellence. #ThumbsUp';

const tipMessageCommitLength0 = 'Come on, you can and have to do longer commit messages. It is a description of your work, not a trivial text sent with your favorite messaging app. You do not have to write a book, but give as many informations as possible on what was done. Your team will be thankfull and they event might consider inviting you for a drink for being the "commit redactor of the year" :)';


const tipModifiedLinesCommit40 = 'You love living dangerously... Making such big changes before committing can make you loose everything. Try making less changes per commit or making commits more often. Imagine a sunday afternoon, you, coding in front of your computer (behind it\'s way more difficult btw) and suddenly, after changing the core of your software, a T-Rex enters your room breaking your door with a high kick and eats your computer... No commit, no work done. Next time, you should commit more often, after little changes! :D';

const tipModifiedLinesCommit25 = 'It is a bit risky to make so much changes per commit. But hey, if you like it, your move... The day you loose everything because you didn\'t commit your changes soon enough, don\'t come to me crying... Firstly because you don\'t know me, hence you won\'t be able to find me, and secondly because it\'s only your fault. Doing less code per commit isn\'t a bad idea. It allows you to better follow the evolution of the work and if you want to review your commits (or someone else want to), it\'s less in a row, better for morale.';

const tipModifiedLinesCommit15 = 'Good work, you just found the middle ground between to much stuff per commit or too much commits for no stuff. It is easy to catch up and find what you did for each commits and there are not over 9000 commits for just changing the name of your toString method.';

const tipModifiedLinesCommit10 = 'Hey, your changes per commit are a bit light! Thus for a good day of work, you end up having way too much commits. It\'s not that bad, but you can do a bit better and try making more significant changes before committing them. The thing is to find a good in between, not too much changes per commit and not too much commits for little changes... But you\'re not so far, keep it that way!';

const tipModifiedLinesCommit0 = 'What the fuuuuuuuuuck man? Even my Grandma makes more changes per commit... I don\'t even know what to say! I mean, making a commit per line is not that good... When your colleagues pull the changes, if they want to catch up and read the commits, they will be lost in miserable changes and a tsunami of commits... Not so productive :/';


const tipLanguage8 = 'WOW, ok, you are curious, that\'s good, but you know it\'s a sin (not a big one though, but still)? You are VERY versatile, but we doubt that you master every single language that you use. If that\'s the case, congratulation, you are the apex programmer. But otherwise, you might consider reducing your arsenal in order to better use your weapons. Sure a Swiss Knife is useful, but you\'ll still use a kitchen knife to chop your vegetables.';

const tipLanguage5 = 'You try to be versatile but man, maybe you should focus on a little less tools. It\'s good to know some languages, but it\'s way better to master a few languages. This way you\'ll have the knowledge to use a little bit of everything, mais you\'ll also be able to increase you productivity on the mastered tools. Your colleagues will even be impressed by how confident you\'ll look by smashing your keys frenetically, typing your bubble-sort method at the light of speed :)';

const tipLanguage3 = 'Welp, what do you expect us to say? You are pretty versatile as a programmer and you know what you are doing with your tools. That\'s a very appreciated set of skills that you have here. Try to keep using these main languages as you need/want, but don\'t restrain yourself to sometimes use other languages.';
